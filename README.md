...
<i><b>Поэтому перед запуском проверьте .env файл:
...
<small>Данный вариант нашего проекта использует бд типа SQLITE с небольшим количеством тестовых данных. 
...
<i>Работа с базой sqlite фактические ничем не отличается от работы с базой postgres. Различие имеется лишь в ссылке на бд.<br>
